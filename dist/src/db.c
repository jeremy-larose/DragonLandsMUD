...
int gsn_pugilism;
short gsn_long_swords;
short gsn_short_swords;
short gsn_rapiers;
short gsn_scimitars;
short gsn_daggers;
short gsn_whips;
...
/* proficiencies - Seikyr */
short gsn_acrobatics;
short gsn_athletics;
short gsn_insight;
short gsn_medicine;
short gsn_performance;
short gsn_sleight_of_hand;
short gsn_animal_handling;
short gsn_deception;
short gsn_intimidation;
short gsn_nature;
short gsn_persuasion;
short gsn_stealth;
short gsn_arcana;
short gsn_history;
short gsn_investigation;
...
short gsn_improved_critical;
short gsn_superior_critical;
short gsn_survivor;
short gsn_archery_style;
short gsn_defense_style;
short gsn_dueling_style;
short gsn_great_weapon_style;
short gsn_protection_style;
short gsn_two_weapon_style;
short gsn_indomitable;
short gsn_action_surge;
short gsn_second_wind;
short gsn_kick;
short gsn_parry;
short gsn_rescue;
...
short gsn_uncanny_dodge;
short gsn_evasion;
short gsn_blindsense;
short gsn_stroke_of_luck;
...
short gsn_giant;
short gsn_infernal;
short gsn_primordial;
short gsn_undercommon;
short gsn_thieves_cant;
...
//   load_specfuns(  );
    ...
    */
   {
      ...
      ASSIGN_GSN( gsn_long_swords, "long swords" );
      ASSIGN_GSN( gsn_short_swords, "short swords" );
      ASSIGN_GSN( gsn_scimitars, "scimitars" );
      ASSIGN_GSN( gsn_rapiers, "rapiers" );
      ...
      ASSIGN_GSN( gsn_xbows, "crossbows" );
      ASSIGN_GSN( gsn_javelins, "javelins" );
      ASSIGN_GSN( gsn_halberds, "halberds" );
      ASSIGN_GSN( gsn_sickles, "sickles" );
      ASSIGN_GSN( gsn_hammers, "hammers" );
      ASSIGN_GSN( gsn_darts, "darts" );
      ASSIGN_GSN( gsn_lances, "lances" );
      ASSIGN_GSN( gsn_nets, "nets" );
      ASSIGN_GSN( gsn_clubs, "clubs" );
      
      /*
       * Assign gsn's for new proficiencies - Seikyr
       */
      ASSIGN_GSN( gsn_acrobatics, "acrobatics" );
      ASSIGN_GSN( gsn_athletics, "athletics" );
      ASSIGN_GSN( gsn_insight, "insight" );
      ASSIGN_GSN( gsn_medicine, "medicine" );
      ASSIGN_GSN( gsn_performance, "performance" );
      ASSIGN_GSN( gsn_sleight_of_hand, "sleight of hand" );
      ASSIGN_GSN( gsn_animal_handling, "animal handling" );
      ASSIGN_GSN( gsn_deception, "deception" );
      ASSIGN_GSN( gsn_intimidation, "intimidation" );
      ASSIGN_GSN( gsn_nature, "nature" );
      ASSIGN_GSN( gsn_persuasion, "persuasion" );
      ASSIGN_GSN( gsn_stealth, "stealth" );
      ASSIGN_GSN( gsn_arcana, "arcana" );
      ASSIGN_GSN( gsn_history, "history" );
      ASSIGN_GSN( gsn_investigation, "investigation" );
      ASSIGN_GSN( gsn_perception, "perception" );
      ASSIGN_GSN( gsn_religion, "religion" );
      ASSIGN_GSN( gsn_survival, "survival" );
      ...
      ASSIGN_GSN( gsn_improved_critical, "improved critical" );
      ASSIGN_GSN( gsn_superior_critical, "superior critical" );
      ASSIGN_GSN( gsn_survivor, "survivor" );
      ASSIGN_GSN( gsn_archery_style, "archery style" );
      ASSIGN_GSN( gsn_defense_style, "defense style" );
      ASSIGN_GSN( gsn_dueling_style, "dueling style" );
      ASSIGN_GSN( gsn_great_weapon_style, "great weapon style" );
      ASSIGN_GSN( gsn_protection_style, "protection style" );
      ASSIGN_GSN( gsn_two_weapon_style, "two weapon style" );
      ASSIGN_GSN( gsn_indomitable, "indomitable" );
      ASSIGN_GSN( gsn_second_wind, "secondwind" );
      ASSIGN_GSN( gsn_action_surge, "actionsurge" );
      ASSIGN_GSN( gsn_remarkable_athlete, "remarkable athlete" );
      ASSIGN_GSN( gsn_stroke_of_luck, "strokeofluck" );
      ...
      ASSIGN_GSN( gsn_trollish, "troll" );
      ASSIGN_GSN( gsn_goblin, "goblin" );
      ASSIGN_GSN( gsn_halfling, "halfling" );
      ASSIGN_GSN( gsn_gnomish, "gnomish" );
      ASSIGN_GSN( gsn_abyssal, "abyssal" );
      ASSIGN_GSN( gsn_deep_speech, "deep speech" );
      ASSIGN_GSN( gsn_magical, "magical" );
      ASSIGN_GSN( gsn_sylvan, "sylvan" );
      ASSIGN_GSN( gsn_celestial, "celestial" );
      ASSIGN_GSN( gsn_draconic, "draconic" );
      ASSIGN_GSN( gsn_giant, "giant" );
      ASSIGN_GSN( gsn_infernal, "infernal" );
      ASSIGN_GSN( gsn_primordial, "primordial" );
      ASSIGN_GSN( gsn_undercommon, "undercommon" );
      ASSIGN_GSN( gsn_thieves_cant, "thieves cant" );
   }
   ...
   log_string( "Loading Mob Special Functions" );
   load_specs(  );
...
void load_mobiles( AREA_DATA * tarea, FILE * fp )
{
   ...
   for( ;; )
   {
      ...
      pMobIndex->lore = fread_string( fp );
      ...
      pMobIndex->challenge_rating = fread_number( fp ); /* Mob Challenge Rating */

      pMobIndex->mobthac0 = fread_number( fp );
      pMobIndex->base_armor = fread_number( fp );
      ...
      if( letter == 'C' )  /* Realms complex mob   -Thoric */
      {
         ...
         pMobIndex->saving_str = fread_number( fp );
         pMobIndex->saving_dex = fread_number( fp );
         pMobIndex->saving_con = fread_number( fp );
         pMobIndex->saving_int = fread_number( fp );
         pMobIndex->saving_wis = fread_number( fp );
        pMobIndex->saving_cha = fread_number( fp );
         ...
         pMobIndex->subclasses = fread_bitvector( fp );
         pMobIndex->subrace = fread_bitvector( fp );
      }
      else
      {
         ...
         xCLEAR_BITS( pMobIndex->subclasses );
         xCLEAR_BITS( pMobIndex->subrace );
      }
   ...
   for( ;; )
   {
      ...
      switch ( letter )
      {
         ...
         case 'P':
            ...
            {
               if( arg3 == 0 )
                  arg3 = OBJ_VNUM_COPPER_ONE; /* This may look stupid, but for some reason it works. */
               add_reset( pRoomIndex, letter, extra, arg1, arg2, arg3 );
            }
            break;
...
void load_rooms( AREA_DATA * tarea, FILE * fp )
{
   ...
   for( ;; )
   {
      ...
      pRoomIndex->perdesc = fread_string( fp );
      pRoomIndex->nightdesc = fread_string( fp );
      ...
      sscanf( ln, "%d %d %d %d %d %d %d", &x3, &x4, &x5, &x6, &x7, &x8, &x9 );
      ...
      pRoomIndex->percheck = x8;
      pRoomIndex->height = x9;
   ...
   for( ;; )
   {
      ...
      switch ( letter = fread_letter( fp ) )
      {
         ...
         case 'M':
         {
            ...
            pMobIndex->spec_fun = get_spec( temp );
...
CHAR_DATA *create_mobile( MOB_INDEX_DATA * pMobIndex )
{
    ...
    * was:  if ( !pMobIndex->ac )
    */
    mob->base_armor = pMobIndex->base_armor;
   ...
   mob->saving_str = pMobIndex->saving_str;
   mob->saving_dex = pMobIndex->saving_dex;
   mob->saving_con = pMobIndex->saving_con;
   mob->saving_int = pMobIndex->saving_int;
   mob->saving_wis = pMobIndex->saving_wis;
   mob->saving_cha = pMobIndex->saving_cha;
   mob->size = pMobIndex->size;
   mob->type = pMobIndex->type;
   ...
   mob->subrace = pMobIndex->subrace;
   mob->subclasses = pMobIndex->subclasses;
   mob->z = pMobIndex->z;
   mob->speechcolor = pMobIndex->speechcolor;
...
OBJ_DATA *create_object( OBJ_INDEX_DATA * pObjIndex, int level )
{
   ...
   obj->lore = QUICKLINK( pObjIndex->lore );
   obj->owner = STRALLOC( "" );
...
void clear_char( CHAR_DATA * ch )
{
   ...
   xCLEAR_BITS( ch->subclasses );
   xCLEAR_BITS( ch->subrace );
...
void free_char( CHAR_DATA * ch )
{
   ...
   MULTICLASS_DATA *multiclass, *multiclass_next;
   SPELL_PREP_DATA *prep, *prep_next;
   GREET_DATA *greet, *greet_next;
   COOLDOWN_DATA *cooldown, *cooldown_next;
   ATTACK_DATA *attack, *attack_next;
   ...
   for( multiclass = ch->first_multiclass; multiclass; multiclass = multiclass_next )
   {
      multiclass_next = multiclass->next;
      UNLINK( multiclass, ch->first_multiclass, ch->last_multiclass, next, prev );
      DISPOSE( multiclass );
   }

   for( greet = ch->first_greet; greet; greet = greet_next )
   {
      greet_next = greet->next;
      UNLINK( greet, ch->first_greet, ch->last_greet, next, prev );
      DISPOSE( greet );
   }

   for( prep = ch->first_prep; prep; prep = prep_next )
   {
      prep_next = prep->next;
      UNLINK( prep, ch->first_prep, ch->last_prep, next, prev );
      DISPOSE( prep );
   }

   for( cooldown = ch->first_cooldown; cooldown; cooldown = cooldown_next )
   {
      cooldown_next = cooldown->next;
      UNLINK( cooldown, ch->first_cooldown, ch->last_cooldown, next, prev );
      DISPOSE( cooldown );
   }
...
const char *format( const char *fmt, ... ) 
 { 
    ...
    if( buf[0] == '\0' ) 
       return " "; 
    mudstrlcpy( newstring, buf, MAX_INPUT_LENGTH ); 
    return newstring; 
 }
...
void make_wizlist(  )
{
   ...
   unlink( WIZLIST_FILE );
   snprintf( buf, MAX_STRING_LENGTH, "  &RAdmin & Deity Teams for %s", sysdata.mud_name );
   towizfile( buf );
/*  towizfile( " Masters of the Realms of Despair!" );*/
   ...
   for( wiz = first_wiz; wiz; wiz = wiz->next )
   {
      if( wiz->level < ilevel )
      {
         ...
         {
            case MAX_LEVEL - 0:
               towizfile( " &ROverseers&W" );
               break;
            case MAX_LEVEL - 1:
               towizfile( " &RHead Admins&W" );
               break;
            case MAX_LEVEL - 2:
               towizfile( " &RAdmins Level 1&W" );
               break;
            case MAX_LEVEL - 3:
               towizfile( " &RAdmins Level 2&W" );
               break;
            case MAX_LEVEL - 4:
               towizfile( " &RQuest Team&W" );
               break;
            case MAX_LEVEL - 5:
               towizfile( " &RNewbie Team&W" );
               break;
            case MAX_LEVEL - 6:
               towizfile( " &RGreater Powers&W" );
               break;
            case MAX_LEVEL - 7:
               towizfile( " &RGreater Powers&W" );
               break;
            case MAX_LEVEL - 8:
               towizfile( " &RIntermediate Powers&W" );
               break;
            case MAX_LEVEL - 9:
               towizfile( " &RIntermediate Powers&W" );
               break;
            case MAX_LEVEL - 10:
               towizfile( " &RLesser Powers&W" );
               break;
            case MAX_LEVEL - 11:
               towizfile( " &RLesser Powers&W" );
               break;
            case MAX_LEVEL - 12:
               ...
               break;
            case MAX_LEVEL - 13:
               towizfile( " &RDemi Gods&W" );
               break;
            case MAX_LEVEL - 14:
               towizfile( " &RDragons & Demons&W" );
               break;
            case MAX_LEVEL - 15:
               towizfile( " &RRetired Admins&W" );
               break;
            case MAX_LEVEL - 16:
               towizfile( " &RGuest Admins&W" );
               break;
            default:
               towizfile( " &RServants" );
               break;
...
void delete_room ( ROOM_INDEX_DATA * room )
{
   ...
   for( ch = first_char; ch; ch = ch->next )
   {
      ...
      else if( ch->substate == SUB_ROOM_PERDESC && ch->dest_buf == room )
      {
         send_to_char( "The room is no more.\r\n", ch );
         stop_editing( ch );
         ch->substate = SUB_NONE;
      ...
      else if( ch->substate == SUB_ROOM_NIGHTDESC && ch->dest_buf == room )
      {
         send_to_char( "The room is no more.\r\n", ch );
         stop_editing( ch );
         ch->substate = SUB_NONE;
...
ROOM_INDEX_DATA *make_room( int vnum, AREA_DATA * area )
{
   ...
   pRoomIndex->perdesc = STRALLOC( "" );
   pRoomIndex->nightdesc = STRALLOC( "" );
...
OBJ_INDEX_DATA *make_object( int vnum, int cvnum, const char *name )
{
   ...
   else
   {
      ...
      pObjIndex->lore = QUICKLINK( cObjIndex->lore );
      ...
      pObjIndex->armor_type = cObjIndex->armor_type;
      pObjIndex->size = cObjIndex->size;
...
MOB_INDEX_DATA *make_mobile( int vnum, int cvnum, const char *name )
{
   ...
   if( !cMobIndex )
   {
      ...
      pMobIndex->level = 1;
      pMobIndex->challenge_rating = 0;
      pMobIndex->mobthac0 = 0;
      pMobIndex->armor = 0;
      pMobIndex->base_armor = 10;
   ...
   else
   {
      ...
      pMobIndex->lore = QUICKLINK( cMobIndex->lore ); 
      ...
      pMobIndex->challenge_rating = cMobIndex->challenge_rating;
      pMobIndex->mobthac0 = cMobIndex->mobthac0;
      pMobIndex->armor = cMobIndex->armor;
      pMobIndex->base_armor = cMobIndex->base_armor;
      ...
      pMobIndex->size = cMobIndex->size;
      pMobIndex->subrace = cMobIndex->subrace;
      pMobIndex->subclasses = cMobIndex->subclasses;
      pMobIndex->speechcolor = cMobIndex->speechcolor;
      pMobIndex->z = cMobIndex->z;
   }
   iHash = vnum % MAX_KEY_HASH;
   pMobIndex->next = mob_index_hash[iHash];
   mob_index_hash[iHash] = pMobIndex;
...
void fread_fuss_exit( FILE * fp, ROOM_INDEX_DATA * pRoomIndex )
{
   ...
   for( ;; )
   {
      ...
      switch ( word[0] )
      {
         ...
         case 'M':
            KEY( "MapX", pexit->x, fread_number( fp ) );
            KEY( "MapY", pexit->y, fread_number( fp ) );
            break;
   ...
   for( ;; )
   {
      ...
      switch ( word[0] )
      {
         ...
         case '#':
            if( !str_cmp( word, "#ENDROOM" ) )
            {
               if( !pRoomIndex->description )
                ...
                if( !pRoomIndex->perdesc )
                    pRoomIndex->perdesc = STRALLOC( "" );
                    
                if( !pRoomIndex->nightdesc )
                    pRoomIndex->nightdesc = STRALLOC( "" );
         ...
         case 'N':
            ...
            KEY( "NightDesc", pRoomIndex->nightdesc, fread_string( fp ) );
            break;
        
        case 'P':
            KEY( "PerDesc", pRoomIndex->perdesc, fread_string( fp ) );
            break;
         ...
         case 'S':
            ...
            {
               int sector = get_sect_type( fread_flagstring( fp ) );
            ...
            if( !str_cmp( word, "Stats" ) )
            {
               ...
               pRoomIndex->percheck = x5;
               pRoomIndex->height = x6;
...
void fread_fuss_object( FILE * fp, AREA_DATA * tarea )
{
   ...
   for( ;; )
   {
      ...
      switch ( word[0] )
      {
         ...
         case 'L':
            KEY( "Lore", pObjIndex->lore, fread_string( fp ) );
         ...
         case 'S':
            ...
            if( !str_cmp( word, "Stats" ) )
            {
               ...
               pObjIndex->weight = x1;
               pObjIndex->gold_cost = x2;
               pObjIndex->silver_cost = x3;
               pObjIndex->copper_cost = x4;
               pObjIndex->rent = x5;
               pObjIndex->level = x6;
               pObjIndex->layers = x7;
      ...
      switch ( word[0] )
      {
         ...
         case 'C':
            if( !str_cmp( word, "Class" ) )
            {
               ...
               {
                  bug( "%s: vnum %d: Mob has invalid Class! Defaulting to fighter.", __func__, pMobIndex->vnum );
                  Class = get_npc_class( "fighter" );
               }
            ...
            if( !str_cmp( word, "Immune" ) )
            {
               ...
               while( immune[0] != '\0' )
               {
                  ...
                  if( value < 0 || value > MAX_BITS )
                     ...
                     xSET_BIT( pMobIndex->immune, value );
               }
         ...
         case 'L':
            ...
            KEY( "Lore", pMobIndex->lore, fread_string( fp ) );
            break;
            ...
            if( !str_cmp( word, "Resist" ) )
            {
               ...
               while( resist[0] != '\0' )
               {
                  ...
                  if( value < 0 || value > MAX_BITS )
                     ...
                     xSET_BIT( pMobIndex->resistant, value );
               }
         ...
         case 'S':
            if( !str_cmp( word, "Saves" ) )
            {
               ...
               pMobIndex->saving_str = x1;
               pMobIndex->saving_dex = x2;
               pMobIndex->saving_con = x3;
               pMobIndex->saving_int = x4;
               pMobIndex->saving_wis = x5;
               pMobIndex->saving_cha = x6;
            ...
            if( !str_cmp( word, "Specfun" ) )
            {
               ...
               if( !( pMobIndex->spec_fun = get_spec( temp ) ) )
               {
            ...
            if( !str_cmp( word, "Stats1" ) )
            {
               ...
               pMobIndex->level = x2;
               pMobIndex->challenge_rating = x3;
               pMobIndex->mobthac0 = x4;
               pMobIndex->base_armor = x5;
               pMobIndex->armor = x6;
               pMobIndex->gold = x7;
               pMobIndex->silver = x8;
               pMobIndex->copper = x9;
            ...
            {
               const char *subclass = fread_flagstring( fp );

               while( subclass[0] != '\0' )
               {
                  subclass = one_argument( subclass, flag );
                  value = get_subclassflag( flag );
                  if( value < 0 || value > MAX_BITS )
                     bug( "Unknown SUBCLASS flag (S): %s", flag );
                  else
                     xSET_BIT( pMobIndex->subclasses, value );
               }
            ...
            if( !str_cmp( word, "Subrace" ) )
            {
               const char *subrace = fread_flagstring( fp );

               while( subrace[0] != '\0' )
               {
                  subrace = one_argument( subrace, flag );
                  value = get_subraceflag( flag );
                  if( value < 0 || value > MAX_BITS )
                     bug( "Unknown SUBRACE flag (S): %s", flag );
                  else
                     xSET_BIT( pMobIndex->subrace, value );
               }
            ...
            if( !str_cmp( word, "Suscept" ) )
            {
               ...
               while( suscep[0] != '\0' )
               {
                  ...
                  if( value < 0 || value > MAX_BITS )
                     ...
                     xSET_BIT( pMobIndex->susceptible, value );
               }
...
void fread_fuss_areadata( FILE * fp, AREA_DATA * tarea )
{
   ...
   for( ;; )
   {
      ...
      switch ( word[0] )
      {
        ...
        case 'L':
            KEY( "Lore", tarea->lore, fread_string( fp ) );
            break;
      ...
      if( !str_cmp( lmsg->name, ch->name ) )
      {
         ...
         switch ( lmsg->type )
         {
            case 0: /* Imm sent message */
            {
               ...
               ch_printf( ch, "\r\n&YA swirling message appears before your eyes from your deity:&w\r\n&w%s\r\n", lmsg->text );
               break;
            }
