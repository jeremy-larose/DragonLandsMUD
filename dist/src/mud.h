...
typedef struct spell_slot_data SPELL_SLOT_DATA; /* Spell Slots 1/17 JL */
...
#define MAX_CLASS             20
#define MAX_NPC_CLASS         18
#define MAX_RACE              24
#define MAX_NPC_RACE          91
#define MAX_NPC_TYPE          16
#define MAX_MSG               18
#define MAX_OINVOKE_QUANTITY  20
#define MAX_BACKGROUND        15
...
#define MAX_CIRCLE_LEVEL            26   /* maximum # of circles */
#define FULL_CASTER                 0    /* Caster classes with full spell progression */
#define HALF_CASTER                 1    /* Half spell progression */
#define THIRD_CASTER                2    /* 1/3rd spell progression */
#define MAX_SLOT_LEVEL              26   /* maximum # of level progressions */
#define MS                          MAX_SLOT_LEVEL
...
struct morph_data
{
   ...
   short saving_str; /* Below are saving adjusted */
   short saving_dex;
   short saving_con;
   short saving_int;
   short saving_wis;
...
/* CON_FORKED, CON_IAFORKED, */
   ...
   CON_EDITING, CON_ADVANCE_LEVEL, CON_RAISE_STAT,
/* New level up code - Seikyr 12.16.2019 */
   CON_CHOOSE_WEAPONSTYLE_FIGHTER, CON_ROLL_STATS_1, CON_ROLL_STATS_2,
   CON_ROLL_STATS_3, CON_ROLL_STATS_4, CON_ROLL_STATS_5,
   CON_ROLL_STATS_6, CON_CONFIRM_NEW_STATS, CON_CONFIRM_NEW_RACE,
   CON_CONFIRM_NEW_CLASS, CON_RAISE_STATS, CON_CHOOSE_WEAPONSTYLE_RANGER,
   CON_CHOOSE_FAVORED_ENEMY
} connection_types;
...
typedef enum
{
   ...
   SUB_PROJ_DESC, SUB_NEWS_POST, SUB_NEWS_EDIT, SUB_JOURNAL_WRITE, SUB_ROOM_PERDESC,
   SUB_ROOM_NIGHTDESC, SUB_AREA_LORE, SUB_OBJ_LORE, SUB_MOB_LORE, SUB_OVERLAND_DESC,
   /*
...
typedef enum
{
   RACE_HUMAN, RACE_AVARIEL, RACE_HILL_DWARF, RACE_MOUNTAIN_DWARF, RACE_HIGH_ELF, RACE_WOOD_ELF,
   RACE_DARK_ELF, RACE_LIGHTFOOT_HALFLING, RACE_STOUT_HALFLING, RACE_DRAGONBORN, RACE_FOREST_GNOME,
   RACE_ROCK_GNOME, RACE_HALF_ELF, RACE_HALF_ORC, RACE_TIEFLING, RACE_AASIMAR, RACE_LIZARDMAN, RACE_FEYBORN
} race_types;
...
#define CLASS_WARLOCK      11
#define CLASS_MYSTIC       12 /* Witchy Cleric/Mage like class */
#define CLASS_ARTIFICER    13 /* New Classes 1/5/2017 JL */
#define CLASS_OATHBREAKER  14 /* New Class 6/27/2018 JPG */
#define CLASS_ADVENTURER   15 /* Generic non-hero like class with more customization options */
#define CLASS_SWORDMAGE    16 /* New Class 6/27/2018 JPG */
#define CLASS_PSION        17 /* New Class 6/27/2018 JPG */
...
#define LANG_SYLVAN      BV03 /* Pixie/Fairy base language */
...
#define LANG_ABYSSAL     BV21
#define LANG_DEEPSPEECH  BV22
#define LANG_CELESTIAL   BV23
#define LANG_DRACONIC    BV24
#define LANG_GIANT       BV25
#define LANG_INFERNAL    BV26
#define LANG_PRIMORDIAL  BV27
#define LANG_UNDERCOMMON BV28
#define LANG_THIEVESCANT BV29
#define LANG_UNKNOWN        0 /* Anything that doesnt fit a category */
#define VALID_LANGS    ( LANG_COMMON | LANG_ELVEN | LANG_DWARVEN | LANG_SYLVAN  \
		       | LANG_OGRE | LANG_ORCISH | LANG_TROLLISH | LANG_GOBLIN \
		       | LANG_HALFLING | LANG_GITH | LANG_GNOME  | LANG_ABYSSAL\
                       | LANG_DEEPSPEECH | LANG_MAGICAL          | LANG_CELESTIAL\
                       | LANG_DRACONIC | LANG_GIANT | LANG_INFERNAL | LANG_PRIMORDIAL \
                       | LANG_UNDERCOMMON | LANG_THIEVESCANT )
/* 19 Languages */
...
struct class_type
{
   ...
   short caster_type; /* 5e D&D Spell Slot System - Seikyr 1/17 */
   short saving_throw_one; /* 5th Edition D&D Saving Throws -- Seikyr 1/17 */
   short saving_throw_two; /* 5th Edition D&D Saving Throws -- Seikyr 1/17 */
   short spell_mod_stat; /* 5th Edition D&D Spell System -- Seikyr 1/17 */
   EXT_BV subclass; /* New subclassing system Seikyr 7/15 */
...
struct race_type
{
   ...
   short race_recall;
   short size;
   EXT_BV subrace; /* New subrace system Seikyr 7/15 */
};
...
typedef struct greet_data GREET_DATA;
void add_greet( CHAR_DATA * ch, const char *name );
...
typedef struct multiclass_data MULTICLASS_DATA;
struct multiclass_data
{
   MULTICLASS_DATA *next;
   MULTICLASS_DATA *prev;
   int classname;
   int level;
};

typedef struct spell_prep_data SPELL_PREP_DATA;
struct spell_prep_data
{
    SPELL_PREP_DATA *next;
    SPELL_PREP_DATA *prev;
    bool fully_prepped;
    int circle;
    short mem_wait;
    int sn:10;
...
struct full_cast_type
{
    short level;
    short slot_max[MAX_PER_SLOT];
};

struct half_cast_type
{
    short level;
    short slot_max[MAX_PER_SLOT];
};
struct third_cast_type
{
    short level;
    short slot_max[MAX_PER_SLOT];
};
...
{
    short level;
    int circle_max[MAX_CIRCLE_LEVEL];
};
...
#define ACT_DAY            31 /* Only out during the day */
#define ACT_NIGHT          32 /* Only out at night */
#define ACT_ONMAP          33 /* Overland map code */
/* 34 acts */
...
typedef enum
{
   ...
   AFF_CONTAGIOUS, AFF_ACIDMIST, AFF_VENOMSHIELD, AFF_GRAPPLE,
   AFF_BARKSKIN, AFF_MAGE_ARMOR, AFF_SPIRITGUARDIANS, AFF_DEAF,
   AFF_LUCKY, AFF_DISENGAGE, AFF_GOADED, AFF_FEINTED, AFF_PRONE, AFF_EARTHQUAKE,
   AFF_FRIGHTEN, AFF_ELDRITCH, AFF_SPIRIT,
   MAX_AFFECTED_BY
} affected_by_types;
...
typedef enum
{
   ...
   ABIL_DISENGAGE, ABIL_INDOMITABLE, ABIL_DISARMING_STRIKE, ABIL_FEINT, ABIL_DISTRACTING_STRIKE,
   ABIL_GOADING_ATTACK, ABIL_TRIP_ATTACK, ABIL_PARRY, ABIL_MENACING_ATTACK, ABIL_RIPOSTE,
   ABIL_COMMANDERS_STRIKE, ABIL_PUSHING_ATTACK, ABIL_EVASIVE_ATTACK,
   /* Eldritch Knight Abilities */
   ABIL_ELDRITCH_STRIKE, ABIL_ARCANE_CHARGE,
   /* Ranger Abilities */
   ABIL_FAVORED_HUMAN, ABIL_LANDS_STRIDE, ABIL_FERAL_SENSES, ABIL_COLOSSUS_SLAYER,
   ABIL_GIANT_KILLER, ABIL_HORDE_BREAKER,
...
#define RIS_LIGHTNING	          BV02
#define RIS_FORCE	          BV03
#define RIS_BLUNT		  BV04
#define RIS_PIERCE	          BV05
#define RIS_SLASH		  BV06
#define RIS_ACID		  BV07
#define RIS_POISON	          BV08
#define RIS_NECROTIC		  BV09
#define RIS_SLEEP		  BV10
#define RIS_CHARM		  BV11
#define RIS_HOLD		  BV12
#define RIS_NONMAGIC	          BV13
#define RIS_MAGIC		  BV14
#define RIS_PARALYSIS		  BV15
#define RIS_PSYCHIC	          BV16
#define RIS_THUNDER		  BV17
#define RIS_RADIANT		  BV18
#define RIS_PLUS1		  BV19
#define RIS_PLUS2		  BV20
#define RIS_PLUS3	          BV21
#define RIS_PLUS4                 BV22
#define RIS_PLUS5                 BV23
#define RIS_PLUS6                 BV24
*/
typedef enum
{
   SUBCLASS_BASE, SUBCLASS_ABJURER, SUBCLASS_CONJURER, SUBCLASS_DIVINATOR,
   SUBCLASS_ENCHANTER, SUBCLASS_EVOKER, SUBCLASS_ILLUSIONIST, SUBCLASS_NECROMANCER,
   SUBCLASS_TRANSMUTER, SUBCLASS_INVENTER, SUBCLASS_THEURGIST, SUBCLASS_WARMAGE,
   SUBCLASS_ORDER, SUBCLASS_FORGE, SUBCLASS_GRAVE, SUBCLASS_PROTECTION, SUBCLASS_KNOWLEDGE,
   SUBCLASS_LIFE, SUBCLASS_LIGHT, SUBCLASS_NATURE, SUBCLASS_TEMPEST, SUBCLASS_TRICKERY,
   SUBCLASS_WAR, SUBCLASS_ARCANA, SUBCLASS_DEATH, SUBCLASS_CITY, SUBCLASS_ARTIFICE,
   SUBCLASS_FEROCITY, SUBCLASS_LAW, SUBCLASS_MADNESS, SUBCLASS_TRAVEL, SUBCLASS_THIEF,
   SUBCLASS_ASSASSIN, SUBCLASS_ARCANETRICKSTER, SUBCLASS_SCOUT, SUBCLASS_SWASHBUCKLER,
   SUBCLASS_CHAMPION, SUBCLASS_BATTLEMASTER, SUBCLASS_ELD_KNIGHT, SUBCLASS_KNIGHT,
   SUBCLASS_BRUTE, SUBCLASS_DEVOTION, SUBCLASS_ANCIENTS, SUBCLASS_VENGEANCE,
   SUBCLASS_OATHBREAKER, SUBCLASS_CONQUEST, SUBCLASS_TREACHERY, SUBCLASS_BEAST,
   SUBCLASS_HUNTER, SUBCLASS_WARDEN, SUBCLASS_SLAYER, SUBCLASS_HORIZONWALKER,
   SUBCLASS_GLOOMSTALKER, SUBCLASS_ANCESTRALGUARDIAN, SUBCLASS_BATTLERAGER,
   SUBCLASS_BERSERKER, SUBCLASS_TOTEMWARRIOR, SUBCLASS_DREAMS, SUBCLASS_LAND, SUBCLASS_MOON,
   SUBCLASS_ARCTIC, SUBCLASS_COAST, SUBCLASS_DESERT, SUBCLASS_FOREST, SUBCLASS_GRASSLAND,
   SUBCLASS_MOUNTAIN, SUBCLASS_SWAMP, SUBCLASS_UNDERDARK, SUBCLASS_SHEPHERD, SUBCLASS_SPORES,
   SUBCLASS_LIFEANDDEATH, SUBCLASS_TWILIGHT, SUBCLASS_LORE, SUBCLASS_GLAMOUR, SUBCLASS_SWORDS,
   SUBCLASS_VALOR, SUBCLASS_WHISPERS, SUBCLASS_DRUNKENMASTER, SUBCLASS_FOURELEMENTS,
   SUBCLASS_KENSAI, SUBCLASS_LONGDEATH, SUBCLASS_OPENHAND, SUBCLASS_MONK_SHADOW, SUBCLASS_SUNSOUL,
   SUBCLASS_DRACONIC, SUBCLASS_DIVINE, SUBCLASS_SEA, SUBCLASS_SORC_SHADOW, SUBCLASS_STONE,
   SUBCLASS_STORM, SUBCLASS_WILD, SUBCLASS_ARCHFEY, SUBCLASS_CELESTIAL, SUBCLASS_FIEND,
   SUBCLASS_OLDONE, SUBCLASS_HEXBLADE, SUBCLASS_UNDYING, SUBCLASS_AVATAR, SUBCLASS_AWAKENED,
   SUBCLASS_IMMORTAL, SUBCLASS_NOMAD, SUBCLASS_SOULKNIFE, SUBCLASS_WUJEN, SUBCLASS_ELD_ARCHER,
   SUBCLASS_SPELLSWORD, MAX_SUBCLASS_TYPE
} subclass_types;

typedef enum
{
   SUBRACE_PURE, SUBRACE_SHADARKAI, SUBRACE_HALFELF, SUBRACE_HALFORC, SUBRACE_HALFDWARF, SUBRACE_HALFHALFLING,
   SUBRACE_HALFGNOME, SUBRACE_FEYBORN, SUBRACE_BLACK, SUBRACE_BLUE, SUBRACE_GREEN, SUBRACE_RED,
   SUBRACE_WHITE, SUBRACE_BRASS, SUBRACE_BRONZE, SUBRACE_COPPER, SUBRACE_GOLD, SUBRACE_SILVER,
   SUBRACE_MOUNTAIN, SUBRACE_HILL, SUBRACE_GRAY, SUBRACE_AVARIEL, SUBRACE_HIGH, SUBRACE_WOOD,
   SUBRACE_DROW, SUBRACE_DARKSEA, SUBRACE_ELADRIN, SUBRACE_WILD, SUBRACE_FOREST, SUBRACE_ROCK,
   SUBRACE_DEEP, SUBRACE_STOUT, SUBRACE_LIGHTFOOT, SUBRACE_ASMODEUS, SUBRACE_DISPATCHER,
   SUBRACE_GLASYA, SUBRACE_LEVISTUS, SUBRACE_MAMMON, SUBRACE_BAALZEBUL, SUBRACE_FIERNA,
   SUBRACE_MEPHISTOPHELES, SUBRACE_ZARIEL, SUBRACE_PROTECTOR, SUBRACE_SCOURGE, SUBRACE_FALLEN,
   SUBRACE_GITHYANKI, SUBRACE_GITHZERAI, SUBRACE_FIRE, SUBRACE_WATER, SUBRACE_AIR, SUBRACE_EARTH,
   MAX_SUBRACE_TYPE
} subrace_types;

typedef enum
{
    RIS_FIRE, RIS_COLD, RIS_LIGHTNING, RIS_FORCE, RIS_BLUNT, RIS_PIERCE,
    RIS_SLASH, RIS_ACID, RIS_POISON, RIS_NECROTIC, RIS_SLEEP, RIS_CHARM,
    RIS_HOLD, RIS_NONMAGIC, RIS_MAGIC, RIS_PARALYSIS, RIS_PSYCHIC,
    RIS_THUNDER, RIS_RADIANT, RIS_PLUS1, RIS_PLUS2, RIS_PLUS3, RIS_PLUS4,
    RIS_PLUS5, RIS_PLUS6, MAX_RIS_TYPE
} ris_types;

typedef enum
{
   RESOURCE_MANA, RESOURCE_DICE, RESOURCE_STAMINA,
   MAX_RESOURCE
} resource_types;
...
typedef enum
{
   ...
   DFND_VENOMSHIELD, DFND_SPIRITGUARDIANS, MAX_DEFENSE_TYPE
} defense_types;
...
typedef enum
{ SD_NONE, SD_FIRE, SD_COLD, SD_LIGHTNING, SD_FORCE, SD_ACID,
   SD_POISON, SD_NECROTIC, SD_PSYCHIC, SD_RADIANT, SD_THUNDER
} spell_dam_types;
...
typedef enum
{ SIZE_TINY, SIZE_SMALL, SIZE_MEDIUM, SIZE_LARGE, SIZE_HUGE, SIZE_GARGANTUAN } size_types;
...
#define OBJ_VNUM_SILVER_ONE	     93
#define OBJ_VNUM_SILVER_SOME	     94
#define OBJ_VNUM_COPPER_ONE	     91
#define OBJ_VNUM_COPPER_SOME	     92
...
typedef enum
{
   ...
   ITEM_PIECE, ITEM_HOUSEKEY, ITEM_DRINK_MIX, ITEM_SILVER, ITEM_COPPER, ITEM_TATTOO,
   ITEM_GEM
} item_types;

#define MAX_ITEM_TYPE		     ITEM_GEM
...
typedef enum
{
   ...
   ITEM_NOREMOVE, ITEM_INVENTORY, ITEM_ANTI_WIZARD, ITEM_ANTI_ROGUE,
   ITEM_ANTI_FIGHTER, ITEM_ANTI_CLERIC, ITEM_ORGANIC, ITEM_METAL, ITEM_DONATION,
   ITEM_CLANOBJECT, ITEM_CLANCORPSE, ITEM_ANTI_BARBARIAN, ITEM_ANTI_DRUID,
   ...
   ITEM_SKINNED, ITEM_ANTI_MONK, ITEM_ANTI_WARLOCK, ITEM_ANTI_SORCERER,
   ITEM_ANTI_PALADIN, ITEM_ANTI_RANGER, ITEM_ANTI_BARD, ITEM_SILVERY, ITEM_VERSATILE,
   ITEM_FINESSE, ITEM_HEAVY, ITEM_LIGHTWEIGHT, ITEM_ONMAP, ITEM_SPIRIT, ITEM_MAX_ITEM_FLAG
} item_extra_flags;
...
#define ITEM_WEAR_BELT		BV21
#define ITEM_WEAR_ONEHAND       BV22
#define ITEM_WEAR_TWOHAND       BV23
...
typedef enum
{
   ...
   APPLY_HITROLL, APPLY_DAMROLL, APPLY_SAVING_STR, APPLY_SAVING_DEX,
   APPLY_SAVING_CON, APPLY_SAVING_INT, APPLY_SAVING_WIS, APPLY_CHA,
   ...
   APPLY_TELEDELAY, APPLY_ATTACKS, APPLY_SAVING_CHA, APPLY_SILVER,
   APPLY_COPPER, APPLY_BASE_AC, APPLY_PRONE, MAX_APPLY_TYPE
} apply_types;
...
#define ROOM_VNUM_ALTAR		  999
#define ROOM_VNUM_SCHOOL	  900
#define ROOM_AUTH_START		    900
#define ROOM_VNUM_HALLOFFALLEN    21195
#define ROOM_VNUM_DEADLY        3009
#define ROOM_VNUM_HELL		401
...
#define BVSECT_HAUNTEDFOREST            BV16
#define BVSECT_HELL                     BV17
#define BVSECT_BEACH                    BV18
#define BVSECT_ASTRAL                   BV19
#define BVSECT_TROPICAL                 BV20
#define BVSECT_CAVERN                   BV21
#define BVSECT_TUNDRA                   BV22
#define BVSECT_CHARRED                  BV23
#define BVSECT_PLAINS                   BV24
#define BVSECT_CORRUPTED                BV25
#define BVSECT_DEEPFOREST               BV26
#define BVSECT_FOOTHILLS                BV27
#define BVSECT_PLATEAU                  BV28
#define BVSECT_HIGHMOUNTAIN             BV29
#define BVSECT_WETLANDS                 BV30
#define BVSECT_VILLAGE                  BV31
#define BVSECT_CASTLE                   BV32
#define BVSECT_RUINS                    BV33
#define BVSECT_ABYSS                    BV34
#define BVSECT_TAVERN                   BV35
#define BVSECT_PRISON                   BV36
#define BVSECT_TEMPLE                   BV37


#define MAX_SECFLAG 			37
...
typedef enum
{
   ...
   ROOM_PROTOTYPE, ROOM_DND, ROOM_TRACK, ROOM_NOWHERE, ROOM_NOTRACK, ROOM_MAP, ROOM_NOSPIRIT, 
   ROOM_MAX
} room_flags;
...
typedef enum
{
   ...
   //SECT_QUICKSAND, SECT_WALL, SECT_GLACIER, SECT_PLAINS, SECT_TRAIL, SECT_BADLANDS,
   //SECT_GRASSLAND, SECT_SCRUB, SECT_BARREN, SECT_BRIDGE, SECT_ROAD, SECT_HELL,
   //SECT_BEACH, SECT_ASTRAL, SECT_TROPICAL, SECT_CAVERN, SECT_MYSTICFOREST, SECT_FOOTHILLS,
   //SECT_WETLANDS, SECT_CASTLE, SECT_RUINS, SECT_ABYSS, SECT_TEMPLE, SECT_HAUNTEDFOREST,
   SECT_INSIDE, SECT_CITY, SECT_FIELD, SECT_FOREST, SECT_HILLS, SECT_MOUNTAIN,
   SECT_WATER_SWIM, SECT_WATER_NOSWIM, SECT_AIR, SECT_UNDERWATER, SECT_DESERT,
   SECT_RIVER, SECT_OCEANFLOOR, SECT_UNDERGROUND, SECT_JUNGLE, SECT_SWAMP,
   SECT_TUNDRA, SECT_ICE, SECT_OCEAN, SECT_LAVA, SECT_SHORE, SECT_TREE, SECT_STONE,
...
typedef enum
{
   ...
   WEAR_MISSILE_WIELD, WEAR_BACK, WEAR_FACE, WEAR_BELT_A, WEAR_BELT_B, WEAR_MAIN_HAND,
   WEAR_OFF_HAND, WEAR_TWOHAND, MAX_WEAR
} wear_locations;
...
/*
 * Positions.
 * Spell Memorization Data 1/17 JL
 */
typedef enum
{
   POS_DEAD, POS_MORTAL, POS_INCAP, POS_STUNNED, POS_SLEEPING, POS_MEMORIZE,
   POS_BERSERK,
...
typedef enum
{
   ...
   PLR_AUTOGOLD, PLR_AUTOMAP, PLR_AFK, PLR_INVISPROMPT, PLR_COMPASS, PLR_DICEROLLS,
   PLR_ONMAP, PLR_MAPEDIT, PLR_AUTOCANTRIP
} player_flags;
...
#define PCFLAG_VAMPIRE        BV24 /* Player is a vampire */
...
struct mob_index_data
{
   ...
   short type;
   short size;
   short challenge_rating;
   short x; /* Coordinate system Seikyr */
   short y;
   short z; /* Height system - Seikyr 12.15.19 */
   short speechcolor; /* Speech Color System - Seikyr 12.16.2019 */
};
...
struct char_data
{
   ...
   PC_DATA *pcdata;
   GREET_DATA *first_greet; /* Greet code */
   GREET_DATA *last_greet;
   BIT_DATA *first_abit;  /* abit/qbit code */
   BIT_DATA *last_abit;
   SPELL_PREP_DATA *first_prep;
   SPELL_PREP_DATA *last_prep;
   COOLDOWN_DATA *first_cooldown; /* Cooldown code */
   COOLDOWN_DATA *last_cooldown;
   //ATTACK_DATA *first_attack; /* New special attacks code */
   //ATTACK_DATA *last_attack;
   MULTICLASS_DATA *first_multiclass;
   MULTICLASS_DATA *last_multiclass;
   short slot_free[MAX_SLOT_LEVEL];
   short slot_max[MAX_SLOT_LEVEL];
   DO_FUN *last_cmd;
   ...
   short challenge_rating; /* New Challenge Rating System JL 1/17 */
   short type;
   short size;
   bool surprised; /* Used for surprise checks - Seikyr 7/15/18 */
   bool bonus_action; /* Used for bonus actions - Seikyr 7/18 */
   bool advantage; /* Used for advantage/disadvantage - Seikyr 12/19 */
   bool disadvantage; /* Used for advantage/disadvantage - Seikyr 12/19 */
   short x; /* Coordinates on the overland map - Samson 7-31-99 */
   short y;
   short z; /* Height system - Seikyr 12.14.19 */
   ...
   short statpoints;
   short speechcolor; /* Speech color - Seikyr 12.16.2019 */
   int classvalues[1]; /* Numbers used for class values */
   bool attacked;
   int bondedweapon[1]; /* Bonded weapons */
};
...
struct pc_data
{
   ...
   SPELL_SLOT_DATA slots[MS][MAX_PER_SLOT];
   ...
   short year;
   int timezone;
   short background; /* New Background code Seikyr 7/17/2018 */
   short secedit; /* Overland Map OLC */
};

/*
 * New profiency type array for proficiency checks - Seikyr
 *

typedef enum
{
    PROF_ACROBATICS, PROF_ANIM_HANDLING, PROF_ARCANA, PROF_ATHLETICS, PROF_DECEPTION,
    PROF_HISTORY, PROF_INSIGHT, PROF_INTIMIDATION, PROF_INVESTIGATION, PROF_MEDICINE,
    PROF_NATURE, PROF_PERCEPTION, PROF_PERFORMANCE, PROF_PERSUASION, PROF_RELIGION,
    PROF_SLEIGHTOFHAND, PROF_STEALTH, PROF_SURVIVAL, PROF_MAX
} proficiency_types;
*/

/* New Weapon type array for proficiency checks - Samson 11-20-99 */
typedef enum
{
   WEP_BAREHAND, WEP_LONG_SWORD, WEP_SHORT_SWORD, WEP_RAPIER, WEP_SCIMITAR,
   WEP_DAGGER, WEP_WHIP, WEP_TALON, WEP_MACE, WEP_BOW, WEP_XBOW, WEP_BLOWGUN,
   WEP_SLING, WEP_AXE, WEP_SPEAR, WEP_STAFF, WEP_JAVELIN, WEP_HALBERD, WEP_SICKLE,
   WEP_CLUB, WEP_LANCE, WEP_HAMMER, WEP_NET, WEP_DART,
   WEP_MAX
} weapon_types;
...
typedef enum
{
   DAM_HIT, DAM_SLASH, DAM_CRUSH, DAM_PIERCE, DAM_MAX_TYPE
} damage_types;
...
struct obj_index_data
{
   ...
   short level;
   short item_type;
   short armor_type; /* 5th Edition Armor Types - Seikyr 1/17 */
   int size;
...
struct exit_data
{
   ...
   short x; /* Coordinates to Overland Map */
   short y;
};
...
struct area_data
{
   ...
   const char *lore; /* Legend Lore Spell; Seikyr 1/17 */
   int flags;
   int low_r_vnum;
   int hi_r_vnum;
   int low_o_vnum;
   ...
   short continent; /* Added for Overland support */
};
...
struct system_data
{
   ...
   int global_silver_looted; /* Silver looted this boot */
   int global_copper_looted; /* Copper looted this boot */
...
struct room_index_data
{
   ...
   const char *name;
   const char *description;
   const char *perdesc; /* Perception check code Seikyr */
   const char *nightdesc; /* Night Room Descriptions Seikyr */
   short percheck; /* Perception check score needed */
   int mpactnum;  /* mudprogs */
   int vnum;
   int tele_vnum;
   int weight;
   ...
   short height;
   short cover; /* Amount of cover to hide in - Seikyr 1.2020 */
};
...
#define TYPE_PROFICIENCY             6000   /* allows for 1000 diseases */
...
typedef enum
{
   ...
   SKILL_HERB, SKILL_RACIAL, SKILL_DISEASE, SKILL_PROFICIENCY
} skill_types;
...
struct skill_type
{
   ...
   short circle[MAX_CLASS];      /* Circle it belongs to         */
   ...
   const char *cast_char;  /* Cast message to caster */
   const char *cast_vict;  /* Cast message to victim */
   const char *cast_room;  /* Cast message to room */
   const char *cast_self;  /* Cast message for self */
   const char *cast_self_room; /* Cast message for room when cast on self */
   const char *help_data;  /* Message that gets put into automated helpfile */
   const char *dice; /* Dice roll         */
   const char *look; /* Display what appears "on-look" message. */
   ...
   short spell_slot; /* Spell Slot - 5th Edition D&D 1/17 JL */
   EXT_BV subclasses; /* Subclasses allowed Seikyr 7/18/2018 */
   short cooldown; /* Cooldown stuff 7/18 JL */
   EXT_BV resource_cost; /* Cost in resources, defined in flags */
...
/* Warrior Skills */
extern short gsn_indomitable;
extern short gsn_second_wind;
extern short gsn_enhanced_damage;
extern short gsn_archery_style;
extern short gsn_defense_style;
extern short gsn_dueling_style;
extern short gsn_great_weapon_style;
extern short gsn_protection_style;
extern short gsn_two_weapon_style;
extern short gsn_improved_critical;
extern short gsn_superior_critical;
extern short gsn_action_surge;
...
extern short gsn_survivor;
extern short gsn_kick;
extern short gsn_parry;
extern short gsn_rescue;
extern short gsn_remarkable_athlete;

/* Rogue Skills */
extern short gsn_uncanny_dodge;
extern short gsn_evasion;
extern short gsn_blindsense;
extern short gsn_stroke_of_luck;
...
extern short gsn_long_swords;
extern short gsn_short_swords;
extern short gsn_scimitars;
extern short gsn_rapiers;
...
extern short gsn_halberds;
extern short gsn_javelins;
extern short gsn_sickles;
extern short gsn_hammers;
extern short gsn_lances;
extern short gsn_darts;
extern short gsn_nets;
extern short gsn_clubs;

/* New proficiencies - Seikyr */
extern short gsn_acrobatics;
extern short gsn_athletics;
extern short gsn_insight;
extern short gsn_medicine;
extern short gsn_performance;
extern short gsn_sleight_of_hand;
extern short gsn_animal_handling;
extern short gsn_deception;
extern short gsn_intimidation;
extern short gsn_nature;
extern short gsn_persuasion;
extern short gsn_stealth;
extern short gsn_arcana;
extern short gsn_history;
extern short gsn_investigation;
extern short gsn_perception;
extern short gsn_religion;
...
extern short gsn_abyssal;
extern short gsn_deep_speech;
extern short gsn_magical;
extern short gsn_sylvan;
extern short gsn_celestial;
extern short gsn_draconic;
extern short gsn_giant;
extern short gsn_infernal;
extern short gsn_primordial;
extern short gsn_undercommon;
extern short gsn_thieves_cant;
...
#define ACTIVE_ABILITY(ch, ability)        (xIS_SET((ch)->abilities, (ability)))
#define HAS_BODYPART(ch, part)	((ch)->xflags == 0 || IS_SET((ch)->xflags, (part)))
#define GET_TIME_PLAYED(ch)     (((ch)->played + (current_time - (ch)->logon)) / 3600)
#define CAN_CAST(ch)		((ch)->Class != 2 && (ch)->Class != 3)

#define IS_VAMPIRE(ch)		((ch)->pcdata && IS_SET( (ch)->pcdata->flags, PCFLAG_VAMPIRE ))\
...
#define GET_AC(ch)		((ch)->base_armor+                           \
                                ( get_eq_char((ch), WEAR_BODY) != NULL ?     \
                                UMIN(dex_app[get_curr_dex(ch)].bonus,        \
                                armor_table[(get_eq_char((ch), WEAR_BODY )->armor_type)].max_dex_mod ) \
                                : dex_app[get_curr_dex(ch)].bonus ) )

#define GET_BASE_AC(ch)         ( get_eq_char((ch), WEAR_BODY) != NULL ?    \
                                armor_table[(get_eq_char((ch), WEAR_BODY )->armor_type)].base_ac \
                                : 10 )
...
#define IS_LIGHTNING(dt)	( IS_VALID_SN(dt) &&			     \
				SPELL_DAMAGE(skill_table[(dt)]) == SD_LIGHTNING )
#define IS_FORCE(dt)		( IS_VALID_SN(dt) &&			     \
				SPELL_DAMAGE(skill_table[(dt)]) == SD_FORCE )

#define IS_NECROTIC(dt)		( IS_VALID_SN(dt) &&			     \
				SPELL_DAMAGE(skill_table[(dt)]) == SD_NECROTIC )

#define IS_POISON(dt)		( IS_VALID_SN(dt) &&			     \
                                SPELL_DAMAGE(skill_table[(dt)]) == SD_POISON )

#define IS_PSYCHIC(dt)          ( IS_VALID_SN(dt) &&                         \
                                SPELL_DAMAGE(skill_table[(dt)]) == SD_PSYCHIC )

#define IS_THUNDER(dt)          ( IS_VALID_SN(dt) &&                         \
                                SPELL_DAMAGE(skill_table[(dt)]) == SD_THUNDER )

#define IS_RADIANT(dt)          ( IS_VALID_SN(dt) &&                         \
                                SPELL_DAMAGE(skill_table[(dt)]) == SD_RADIANT )
...
#define PERS(ch, looker, from )	( can_see( (looker), (ch), (from) ) ?		  \
				( IS_NPC(ch) ? (ch)->short_descr	  \
                                : IS_IMMORTAL(looker) ? (ch)->name        \
                                : is_greeted( (looker), ch ) ? (ch)->name \
                                : (ch)->adjective )                       \
                                : "someone" )
...
extern const struct cha_app_type cha_app[31];
extern const struct lck_app_type lck_app[31];
extern const struct mob_challenge_type  challenge_table[34];
extern const struct full_cast_type full_cast_table[];
extern const struct half_cast_type half_cast_table[];
extern const struct third_cast_type third_cast_table[];
extern const struct max_mem_type max_mem_table[];
extern const struct circle_wait_type circle_wait_table[];
extern const struct level_prog_type level_prog_table[66];
extern const struct base_armor_type armor_table[MAX_ARMOR_TYPE];
...
/* extern char *proficiency_types[PROF_MAX]; */
...
extern const char *const npc_type[];
...
extern const char *const size_table[];
...
extern const char *const subclass_flags[];
extern const char *const subrace_flags[];
extern const char *const background_types[];
extern const char *const feat_flags[];
extern const char *const ability_flags[];
extern const char *const resource_flags[];
...
extern SPEC_DATA *first_specfun;
extern SPEC_DATA *last_specfun;
...
DECLARE_DO_FUN( do_goading_attack );
DECLARE_DO_FUN( do_trip_attack );
DECLARE_DO_FUN( do_distracting_strike );
DECLARE_DO_FUN( do_parry );
DECLARE_DO_FUN( do_menacing_attack );
DECLARE_DO_FUN( do_riposte );
DECLARE_DO_FUN( do_commanders_strike );
DECLARE_DO_FUN( do_maneuvering_attack );
DECLARE_DO_FUN( do_pushing_attack );
DECLARE_DO_FUN( do_evasive_attack );
DECLARE_DO_FUN( do_study );
DECLARE_DO_FUN( do_bond );
DECLARE_DO_FUN( do_arcane_charge );

/*
 * New special functions code -- Seikyr 
 */
DECLARE_DO_FUN( do_showspec );
DECLARE_DO_FUN( do_makespec );
DECLARE_DO_FUN( do_setspec );
DECLARE_DO_FUN( do_weapontest );
...
DECLARE_DO_FUN( do_new_memorize );
...
DECLARE_DO_FUN( do_spellbook ); /* Memorization JL 1/17 */
...
DECLARE_SPELL_FUN( spell_prestig);   /*Added by Beltane, 8/12/18 */
...
/*
 * Commands used by Classes
 */
DECLARE_DO_FUN( do_advance_level );

/* Rogues */
DECLARE_DO_FUN( do_stroke_of_luck );

/* Fighters */
DECLARE_DO_FUN( do_second_wind );
DECLARE_DO_FUN( do_action_surge );
DECLARE_DO_FUN( do_indomitable );
DECLARE_DO_FUN( do_maneuvers );
...
#define SPEC_DIR    "../specials/" /* Special Ability dir */
...
#define SPEC_LIST       "spec.lst"  /* List of special mob behaviors - Seikyr 12.19 */
...
const char *colorize_speech( const char *argument, CHAR_DATA *ch );
...
ch_ret move_char args( ( CHAR_DATA * ch, EXIT_DATA * pexit, int fall, int direction ) );
...
int get_subclassflag( const char *flag );
int get_subraceflag( const char *flag );
int get_featflag( const char *flag );
int get_abilityflag( const char *flag );
int get_resourceflag( const char *flag );
...
int get_sect_type( const char *type );
...
char * strrep args( (const char *s1, const char *s2, const char *s3) );
...
ch_ret damage args( ( CHAR_DATA * ch, CHAR_DATA * victim, int dam, int dt, int hittype ) );
...
void oprog_move_trigger( CHAR_DATA *ch );
...
void nanny_show_stats args( ( DESCRIPTOR_DATA *d, const char *arg ) );
char *attribtext args( ( int attribute ) );
...
short get_curr_slots( CHAR_DATA * ch );
short dc_spellcasting( CHAR_DATA * ch );
short dc_athletics( CHAR_DATA * ch );
short dc_acrobatics( CHAR_DATA * ch );
short dc_animal_handling( CHAR_DATA * ch );
short dc_arcana( CHAR_DATA * ch );
short dc_deception( CHAR_DATA * ch );
short dc_history( CHAR_DATA * ch );
short dc_insight( CHAR_DATA * ch );
short dc_intimidation( CHAR_DATA * ch );
short dc_investigation( CHAR_DATA * ch );
short dc_medicine( CHAR_DATA * ch );
short dc_nature( CHAR_DATA * ch );
short dc_perception( CHAR_DATA * ch, bool silent );
short dc_performance( CHAR_DATA * ch );
short dc_persuasion( CHAR_DATA * ch );
short dc_religion( CHAR_DATA * ch );
short dc_sleight( CHAR_DATA * ch );
short dc_stealth( CHAR_DATA * ch, bool silent );
short dc_survival( CHAR_DATA * ch );
short dc_constitution( CHAR_DATA * ch );
short dc_dexterity( CHAR_DATA * ch );
short dc_strength( CHAR_DATA * ch );
short dc_intelligence( CHAR_DATA * ch );
short dc_charisma( CHAR_DATA * ch );
short dc_wisdom( CHAR_DATA * ch );

bool has_cooldown args( ( CHAR_DATA *ch, int sn ) );
bool has_class args( ( CHAR_DATA *ch, int classname ) );
int class_level args( ( CHAR_DATA *ch, int level ) );
bool can_take_proto args( ( CHAR_DATA * ch ) );
int can_carry_n args( ( CHAR_DATA * ch ) );
int can_carry_w args( ( CHAR_DATA * ch ) );
int can_cast_slot0 args( ( CHAR_DATA * ch ) );
int can_cast_slot1 args( ( CHAR_DATA * ch ) );
int can_cast_slot2 args( ( CHAR_DATA * ch ) );
int can_cast_slot3 args( ( CHAR_DATA * ch ) );
int can_cast_slot4 args( ( CHAR_DATA * ch ) );
int can_cast_slot5 args( ( CHAR_DATA * ch ) );
int can_cast_slot6 args( ( CHAR_DATA * ch ) );
int can_cast_slot7 args( ( CHAR_DATA * ch ) );
int can_cast_slot8 args( ( CHAR_DATA * ch ) );
int can_cast_slot9 args( ( CHAR_DATA * ch ) );
int find_spell_slot args( ( CHAR_DATA *ch, int search_circle ) );
int max_spell_slot_lookup args( ( CHAR_DATA *ch, int slot ) );
int find_cast_slot args( ( CHAR_DATA *ch, int sn ) );
...
int find_spell_level args(( CHAR_DATA * ch, int sn ) );
...
OD *get_bonded_obj_world args( ( CHAR_DATA *ch, int vnum ) );
OD *get_wielded_obj args( ( CHAR_DATA *ch, bool dual_flip ) );
...
bool can_see args( ( CHAR_DATA * ch, CHAR_DATA * victim, bool override ) );
bool can_see_obj args( ( CHAR_DATA * ch, OBJ_DATA * obj ) );
bool can_drop_obj args( ( CHAR_DATA * ch, OBJ_DATA * obj ) );
bool is_greeted args( ( CHAR_DATA * ch, CHAR_DATA * victim ) );
...
int find_proficiency( CHAR_DATA * ch, const char *name, bool know );
int skill_lookup( const char *name );
int herb_lookup( const char *name );
int personal_lookup( CHAR_DATA * ch, const char *name );
int slot_lookup( int slot );
bool saves_str( int level, CHAR_DATA * victim );
bool saves_dex( int level, CHAR_DATA * victim );
bool saves_con( int level, CHAR_DATA * victim );
bool saves_int( int level, CHAR_DATA * victim );
bool saves_wis( int level, CHAR_DATA * victim );
bool saves_cha( int level, CHAR_DATA * victim );
...
void list_mem_spells args( ( CHAR_DATA *ch ) );
...
SPEC_DATA *get_spec( const char *name );
void load_specs( );
...
/* Seikyr's Class System DnD5e 12-19-19 */

/* fighter.c */
short roll_superiority( CHAR_DATA *ch );
short dc_maneuver( CHAR_DATA * ch );
...
typedef enum
{
   ...
   IMMINFO_PROG, LOAD_PROG, MOVE_PROG, BRIBE_COPPER_PROG, BRIBE_SILVER_PROG
} prog_types;
...
#define LEARNED(ch,sn)	    (IS_NPC(ch) ? 0 : URANGE(0, (ch)->pcdata->learned[(sn)], 101))
