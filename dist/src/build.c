...
const char *sect_types[] = {
   ...
   "beach", "tree", "stone", "quicksand", "wall", "glacier", "plains",
   "trail", "badlands", "grasslands", "scrublands", "barren", "bridge", "road",
   "hell", "astral", "tropical", "cavern", "mysticforest", "foothills",
   "wetlands", "castle", "ruins", "abyss", "temple", "hauntedforest"
};
*/
...
const char *const r_flags[] = {
   ...
   "_track_", "nowhere", "notrack", "map", "nospirit"
};
...
const char *const o_flags[] = {
   ...
   "antiwizard", "antirogue", "antifighter", "anticleric", "organic", "metal",
   "donation", "clanobject", "clancorpse", "antibarbarian", "antidruid",
   "hidden", "poisoned", "covering", "deathrot", "buried", "prototype",
   "nolocate", "groundrot", "lootable", "personal", "multi_invoke", "enchanted",
   "permanent", "nofill", "deathdrop", "skinned", "antimonk", "antiwarlock",
   "antisorcerer", "antipaladin", "antiranger", "antibard", "silvery",
   "versatile", "finesse", "heavy", "lightweight", "onmap", "spirit"
};
...
const char *const w_flags[] = {
   ...
   "missile", "back", "face", "belt", "onehand", "twohand", "r6",
...
const char *const item_w_flags[] = {
   ...
   "hold", "dual", "ears", "eyes", "missile", "back", "face", "belt", "belt",
   "mainhand", "offhand", "twohand", "r7", "r8", "r9"
};
...
const char *const o_types[] = {
   ...
   "silver", "copper", "tattoo", "gem"
};

const char *const a_types[] = {
   "none", "strength", "dexterity", "intelligence", "wisdom", "constitution",
   "sex", "class", "level", "age", "height", "weight", "mana", "hit", "move",
   "gold", "experience", "armor", "hitroll", "damroll", "save_str", "save_dex",
   "save_con", "save_int", "save_wis", "charisma", "affected", "resistant",
   ...
   "roomlight", "televnum", "teledelay", "attacks", "save_cha", "silver", "copper",
   "base_ac", "prone", "earthquake"
};
...
const char *const a_flags[] = {
   ...
   "venomshield", "grapple", "barkskin", "mage_armor", "spiritguardians",
   "deaf", "lucky", "disengage", "goaded", "feinted", "prone", "earthquake",
   "frighten", "eldritch", "spirit"
};

const char *const ability_flags[] = {
   /* Begin Battlemaster */
   "disengage", "indomitable", "disarmingstrike", "feint", "distractingstrike",
   "goadingattack", "tripattack", "parry", "menace", "riposte", "commandersstrike",
   "pushingattack", "evasiveattack", 
   /* End Battlemaster */
   /* Begin Eldritch Knight */
   "eldritchattack", "arcanecharge",
   /* Begin Ranger */
   "favored_human", "landstride", "feralsense", "colossusslayer", "giantkiller",
   "hordebreaker"
...
const char *const act_flags[] = {
   ...
   "pacifist", "noattack", "annoying", "statshield", "prototype", "day", "night",
   "onmap"
};
...
/* changed "r8" to "" so players on watch can't see it  -- Gorog */
   ...
   "nohomepage", "vampire", "r25", "r26", "r27", "r28", "r29", "r30", "r31"
};
...
const char *const plr_flags[] = {
   ...
   "flee", "autogold", "automap", "afk", "invisprompt", "compass", "dicerolls",
   "onmap", "mapedit", "autocantrip"
};
...
const char *const ris_flags[] = {
   "fire", "cold", "lightning", "force", "blunt", "pierce", "slash", "acid",
   "poison", "necrotic", "sleep", "charm", "hold", "nonmagic", "magic",
   "paralysis", "psychic", "thunder", "radiant", "plus1", "plus2", "plus3",
   "plus4", "plus5", "plus6"
};

const char *const subclass_flags[] = {
  "base", "abjurer", "conjurer", "divinator", "enchanter", "evoker",
  "illusionist", "necromancer", "transmuter", "inventer", "theurgist", "warmage",   /* Mage Subclasses */
  "order", "forge", "grave", "protection", "knowledge", "life", "light",
  "nature", "tempest", "trickery", "war", "arcana", "death", "city", "artifice",
  "ferocity", "law", "madness", "travel",                                           /* Cleric subclasses */
  "thief", "assassin", "arcanetrickster", "scout", "swashbuckler",                  /* Rogue subclasses */
  "champion", "battlemaster", "eldritchknight", "knight", "brute",                  /* Fighter subclasses */
  "devotion", "ancients", "vengeance", "oathbreaker", "conquest", "treachery",      /* Paladin subclasses */
  "beast", "hunter", "warden", "slayer", "horizonwalker", "gloomstalker",           /* Ranger subclasses */
  "ancestralguardian", "battlerager", "berserker", "totemwarrior",                  /* Barbarian subclasses */
  "dreams", "land", "moon", "arctic", "coast", "desert", "forest", "grassland",
  "mountain", "swamp", "underdark", "shepherd", "spores", "lifeanddeath", "twilight",/*Druid subclasses */
  "lore", "glamour", "swords", "valor", "whispers",                                 /* Bard subclasses */
  "drunkenmaster", "fourelements", "kensai", "longdeath", "openhand", "shadow",
  "sunsoul",                                                                        /* Monk subclasses */
  "draconic", "divine", "sea", "shadow", "stone", "storm", "wild",                  /* Sorcerer subclasses */
  "archfey", "celestial", "fiend", "oldone", "hexblade", "undying",                 /* Warlock subclasses */
  "avatar", "awakened", "immortal", "nomad", "soulknife", "wujen",                  /* Mystic subclasses */
  "eldritcharcher", "spellsword"                                                    /* Swordmage subclasses */
};

const char *const subrace_flags[] = {
    "pure", "shadar-kai", "half-elf", "half-orc", "half-dwarf", "half-halfling",
    "half-gnome", "feyborn",                                                        /* Human subraces */
    "black", "blue", "green", "red", "white", "brass", "bronze", "copper",
    "gold", "silver",                                                               /* Dragonborn subraces */
    "mountain", "hill", "gray",                                                     /* Dwarf subraces */
    "avariel", "high", "wood", "drow", "dark", "eladrin", "wild",                   /* Elf subraces */
    "forest", "rock", "deep",                                                       /* Gnome subraces */
    "stout", "lightfoot",                                                           /* Halfling subraces */
    "asmodeus", "dispatcher", "glasya", "levistus", "mammon", "baalzebul",
    "fierna", "mephisopheles", "zariel",                                            /* Tiefling subraces */
    "protector", "scourge", "fallen",                                               /* Aasimar subraces */
    "githyanki", "githzerai",                                                       /* Gith subraces */
    "fire", "water", "air", "earth"                                                 /* Genasi subraces */
};

const char *const feat_flags[] = {
    "actor", "athlete", "alert", "charger", "defensivedualist", "dualwielder",
    "dungeondelver", "durable", "elementaladept", "grappler", "greatweaponmaster",
    "healer", "inspiringleader", "keenmind", "linguist", "lucky", "mageslayer",
    "magicinitiate", "martialadept", "mobile", "mountedcombatant", "observant",
    "resilient", "ritualcaster", "savageattacker", "sentinel", "sharpshooter",
    "skilled", "skulker", "spellsniper", "tough", "warcaster", "blademastery",
    "crossbowexpert", "fellhanded", "flailmastery", "polearmmaster", "shieldmaster",
    "spearmastery", "tavernbrawler", "weaponmaster", "lightlyarmored", "moderatelyarmored",
    "mediumarmormaster", "heavilyarmored", "heavyarmormaster", "acrobat",
    "animalhandler", "arcanist", "brawny", "diplomat", "empathic", "historian",
    "investigator", "medic", "menacing", "naturalist", "perceptive", "performer",
    "quickfingered", "silvertongued", "stealthy", "survivalist", "theologian",
    "alchemist", "burglar", "gourmand", "masterofdisguise", "barbedhide",
    "bountifulluck", "critterfriend", "dragonfear", "dragonhide", "dragonwings",
    "drowhighmagic", "dwarvenfortitude", "elvenaccuracy", "everybodysfriend",
    "fadeaway", "feytransportation", "flamesphlegethos", "grudgebearer",
    "determination", "infernalconstitution", "orcishaggression", "orcishfury",
    "prodigy", "secondchance", "squatnimbleness", "svirfneblinmagic", "wondermaker",
    "woodelfmagic"
};

const char *const resource_flags[] = {
   "mana", "superioritydice", "stamina"
};
...
const char *const defense_flags[] = {
   ...
   "monsum4", "disarm", "iceshield", "grip", "truesight", "acidmist", "venomshield", "spiritguardians"
};
...
const char *const size_table[] = {
   "tiny", "small", "medium", "large", "huge", "gargantuan"
};

const char *const color_names[MAX_COLORS] = {
...
const char *const mprog_flags[] = {
   ...
   "load", "move", "bribecopper", "bribesilver"
};
...
/*
int get_sectypes( const char *type )
{
...
int get_sect_type( const char *type )
{
   ...
   for( x = 0; x < ( sizeof( sect_types ) / sizeof( sect_types[0] ) ); x++ )
...
int get_subclassflag( const char *flag )
{
   ...
   for( x = 0; x < ( sizeof( subclass_flags ) / sizeof( subclass_flags[0] ) ); x++ )
      if( !str_cmp( flag, subclass_flags[x] ) )
         return x;
   return -1;
}
...
int get_subraceflag( const char *flag )
{
   ...
   for( x = 0; x < ( sizeof( subrace_flags ) / sizeof( subrace_flags[0] ) ); x++ )
      if( !str_cmp( flag, subrace_flags[x] ) )
         return x;
   return -1;
}
...
int get_featflag( const char *flag )
{
   ...
   for( x = 0; x < ( sizeof( feat_flags ) / sizeof( feat_flags[0] ) ); x++ )
      if( !str_cmp( flag, feat_flags[x] ) )
         return x;
   return -1;
}
...
int get_abilityflag( const char *flag )
{
   ...
   for( x = 0; x < ( sizeof( ability_flags ) / sizeof( ability_flags[0] ) ); x++ )
      if( !str_cmp( flag, ability_flags[x] ) )
         return x;
   return -1;
}
...
int get_resourceflag( const char *flag )
{
   ...
   for( x = 0; x < ( sizeof( resource_flags ) / sizeof( resource_flags[0] ) ); x++ )
      if( !str_cmp( flag, resource_flags[x] ) )
         return x;
   return -1;
}
...
void goto_char( CHAR_DATA *ch, CHAR_DATA *wch, char *argument )
{
    ...
    /* Modified bamfout processing by Altrag, installed by Samson 12-10-97 */
       if (ch->pcdata && ch->pcdata->bamfout[0])
         act(AT_IMMORT, "$T", ch, NULL, ch->pcdata->bamfout, TO_CANSEE);
       else
    ...
    /* Modified bamfin processing by Altrag, installed by Samson 12-10-97 */
       if (ch->pcdata && ch->pcdata->bamfin[0])
          act(AT_IMMORT, "$T", ch, NULL, ch->pcdata->bamfin, TO_CANSEE);
       else
...
void do_mset( CHAR_DATA* ch, const char* argument)
{
   ...
   switch ( ch->substate )
   {
      ...
      case SUB_MOB_LORE:
         if( !ch->dest_buf )
         {
            send_to_char( "Fatal error: report to Seikyr.\r\n", ch );
            bug( "%s", "do_mset: sub_mob_lore: NULL ch->dest_buf" );
            ch->substate = SUB_NONE;
            return;
         }
         victim = ( CHAR_DATA * ) ch->dest_buf;
         ...
         STRFREE( victim->lore );
         victim->lore = copy_buffer( ch );
         if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         {
            STRFREE( victim->pIndexData->lore );
            victim->pIndexData->lore = QUICKLINK( victim->lore );
         }
         stop_editing( ch );
         ch->substate = ch->tempnum;
         return;
   ...
   if( arg1[0] == '\0' || ( arg2[0] == '\0' && ch->substate != SUB_REPEATCMD ) || !str_cmp( arg1, "?" ) )
   {
      ...
      send_to_char( "  hitroll damroll basearmor armor affected level\r\n", ch );
      send_to_char( "  thirst drunk full blood flags cr z (for height)\r\n", ch );
      ...
      send_to_char( "  name short long description lore title spec clan\r\n", ch );
      send_to_char( "  council quest qp qpa favor deity\r\n", ch );
      send_to_char( "  adjective subclass subrace background feats\r\n", ch );
      send_to_char( "  speechcolor abilities cv0 cv1\r\n", ch );
      send_to_char( "\r\n", ch );
   ...
   if( !str_cmp( arg2, "savstr" ) )
   {
      ...
      victim->saving_str = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->saving_str = value;
      return;
   }

   if( !str_cmp( arg2, "savdex" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < -30 || value > 30 )
      ...
      victim->saving_dex = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->saving_dex = value;
      return;
   }

   if( !str_cmp( arg2, "savcon" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < -30 || value > 30 )
      ...
      victim->saving_con = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->saving_con = value;
      return;
   }

   if( !str_cmp( arg2, "savint" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < -30 || value > 30 )
      ...
      victim->saving_int = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->saving_int = value;
      return;
   }

   if( !str_cmp( arg2, "savwis" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < -30 || value > 30 )
      ...
      victim->saving_wis = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->saving_wis = value;
      return;
   }

   if( !str_cmp( arg2, "savcha" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < -30 || value > 30 )
      ...
      victim->saving_cha = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->saving_cha = value;
      return;
   }
   if( !str_cmp( arg2, "sex" ) )
   {
   ...
   if( !str_cmp( arg2, "z" ) ) 
   {
      ...
      if( value >= 10 || value < 0 ) {
         ch_printf( ch, "Values range from 0 - 10.\n" );
         return;
      }

      victim->z = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) ) {
         victim->pIndexData->z = value;
      }
      return;
   }

   if( !str_cmp( arg2, "speechcolor" ) ) 
   {
      if( !can_mmodify( ch, victim ) ) 
         return;
      
      if( value < 0 || value > MAX_COLORS ) {
         ch_printf( ch, "Values range from 0 - %d.\n", MAX_COLORS );
         return;
      }

      ch_printf( ch, "Speech color set to %s\r\n", color_names[value] );
      victim->speechcolor = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) ) {
         victim->pIndexData->speechcolor = value;
      }
      return;
   }
   ...
   if( !str_cmp( arg2, "cv0" ) )
   {
      ...
      if( value < minattr || value > maxattr )
      {
         ch_printf( ch, "Classvalues are %d to %d.\r\n", minattr, maxattr );
         return;
      }
      victim->classvalues[0] = value;
      //if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
      //   victim->pIndexData->perm_lck = value;
      return;
   }
   ...
   if( !str_cmp( arg2, "basearmor" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < -300 || value > 300 )
      {
         send_to_char( "Base AC range is -300 to 300.\r\n", ch );
         return;
      }
      victim->base_armor = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->base_armor = value;
      return;
   }
   if( !str_cmp( arg2, "armor" ) )
   {
      ...
      if( value < -300 || value > 300 )
      {
         send_to_char( "AC bonus range is -300 to 300.\r\n", ch );
         return;
      }
      victim->armor = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
   ...
   if( !str_cmp( arg2, "cr" ) )
   {
      ...
      if( value < 0 || value > 30 )
      {
         send_to_char( "CR rating is 0 to 30.\r\n", ch );
         return;
      }
      
      victim->challenge_rating = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->challenge_rating = value;
      return;
   }
   ...
   if( !str_cmp( arg2, "type" ) )
   {
      ...
      if( value < 0 || value > MAX_NPC_TYPE )
      {
         send_to_char( "Mob type is 0 to 15.\r\n", ch );
         return;
      }
      
      victim->type = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->type = value;
      return;
   }
   ...
   if( !str_cmp( arg2, "size" ) )
   {
      ...
      if( value < 0 || value > 5 )
      {
         send_to_char( "Size rating is 0 to 5.\r\n", ch );
         return;
      }
      
      victim->size = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->size = value;
      return;
   }
   if( !str_cmp( arg2, "background" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      ...
      if( value < 0 || value > MAX_BACKGROUND )
      {
         ch_printf( ch, "Backgrounds range from 1 to %d.\r\n", MAX_BACKGROUND );
         return;
      }
      
      victim->pcdata->background = value;
      return;
   }
   ...
   if( !str_cmp( arg2, "exp" ) )
   {
      ...
      {
         send_to_char( "Exp range is 0 to 30,000 exp points.\r\n", ch );
         return;
      }
      victim->exp = value;
      return;
   ...
   if( !str_cmp( arg2, "adjective" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( IS_NPC( victim ) )
      {
         send_to_char( "Not on NPC's... yet.\r\n", ch );
         return;
      }

      if( arg3[0] == '\0' )
      {
         send_to_char( "Adjective set to default.\r\n", ch );
         sprintf( buf, "a young %s %s", victim->sex == SEX_FEMALE ? "female" : "male", race_table[victim->race]->race_name );
         STRFREE( victim->adjective );
         victim->adjective = STRALLOC( buf );
         return;
      }

      STRFREE( victim->adjective );
      victim->adjective = STRALLOC( arg3 );
/*      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
      {
         STRFREE( victim->pIndexData->player_name );
         victim->pIndexData->player_name = QUICKLINK( victim->name );
   ...
   if( !str_cmp( arg2, "lore" ) )
   {
      ...
      if( ch->substate == SUB_REPEATCMD )
         ...
         ch->tempnum = SUB_NONE;
      ch->substate = SUB_MOB_LORE;
      ch->dest_buf = victim;
      start_editing( ch, victim->lore );
      return;
   }
   ...
   if( !str_cmp( arg2, "subclass" ) )
   {
      if( !IS_NPC( victim ) && get_trust( ch ) < LEVEL_LESSER )
      {
         send_to_char( "You can only modify a mobile's subclasses.\r\n", ch );
         return;
      }
      if( !can_mmodify( ch, victim ) )
         return;
      if( !argument || argument[0] == '\0' )
      {
         send_to_char( "Usage: mset <victim> subclass <flag> [flag]...\r\n", ch );
         return;
      }
      while( argument[0] != '\0' )
      {
         argument = one_argument( argument, arg3 );
         value = get_subclassflag( arg3 );
         if( value < 0 || value >= MAX_BITS )
            ch_printf( ch, "Unknown flag: %s\r\n", arg3 );
         else
            xTOGGLE_BIT( victim->subclasses, value );
      }
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->subclasses = victim->subclasses;
      return;
   }
   if( !str_cmp( arg2, "subrace" ) )
   {
      if( !IS_NPC( victim ) && get_trust( ch ) < LEVEL_LESSER )
      {
         send_to_char( "You can only modify a mobile's subrace.\r\n", ch );
         return;
      }
      if( !can_mmodify( ch, victim ) )
         return;
      if( !argument || argument[0] == '\0' )
      {
         send_to_char( "Usage: mset <victim> subrace <flag> [flag]...\r\n", ch );
         return;
      }
      while( argument[0] != '\0' )
      {
         argument = one_argument( argument, arg3 );
         value = get_subraceflag( arg3 );
         if( value < 0 || value >= MAX_BITS )
            ch_printf( ch, "Unknown flag: %s\r\n", arg3 );
         else
            xTOGGLE_BIT( victim->subrace, value );
      }
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->subrace = victim->subrace; 
      return;
   }
   if( !str_cmp( arg2, "feats" ) )
   {
        if( IS_NPC( victim ) )
        {
            send_to_char( "You cannot modify a mobile's feats at this time.\r\n", ch );
            return;
        }
      if( !IS_NPC( victim ) && get_trust( ch ) < LEVEL_LESSER )
      {
         send_to_char( "You can only modify a mobile's feats.\r\n", ch );
         return;
      }
      if( !can_mmodify( ch, victim ) )
         return;
      ...
      if( !argument || argument[0] == '\0' )
      {
         send_to_char( "Usage: mset <victim> feats <flag> [flag]...\r\n", ch );
         return;
      }
      while( argument[0] != '\0' )
      {
         argument = one_argument( argument, arg3 );
         value = get_featflag( arg3 );
         if( value < 0 || value >= MAX_BITS )
            ch_printf( ch, "Unknown flag: %s\r\n", arg3 );
         else
            xTOGGLE_BIT( victim->feats, value );
      }
/*      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->subrace = victim->subrace;  */
      return;
   }
   if( !str_cmp( arg2, "abilities" ) )
   {
      if( !IS_NPC( victim ) && get_trust( ch ) < LEVEL_LESSER )
      {
         send_to_char( "You can only modify a mobile's abilities.\r\n", ch );
         return;
      }
      if( !can_mmodify( ch, victim ) )
         return;
      if( !argument || argument[0] == '\0' )
      {
         send_to_char( "Usage: mset <victim> abilities <flag> [flag]...\r\n", ch );
         return;
      }
      while( argument[0] != '\0' )
      {
         argument = one_argument( argument, arg3 );
         value = get_abilityflag( arg3 );
         if( value < 0 || value >= MAX_BITS )
            ch_printf( ch, "Unknown flag: %s\r\n", arg3 );
         else
            xTOGGLE_BIT( victim->abilities, value );
      }
      //if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
      //   victim->pIndexData->subclasses = victim->subclasses;
      return;
...
void do_oset( CHAR_DATA* ch, const char* argument)
{
   ...
   switch ( ch->substate )
   {
      ...
      case SUB_OBJ_LORE:
         ...
         {
            send_to_char( "Fatal error: report to Seikyr.\r\n", ch );
            bug( "%s: sub_obj_lore: NULL ch->dest_buf", __func__ );
            ch->substate = SUB_NONE;
            return;
         }
         ...
         STRFREE( obj->lore );
         obj->lore = copy_buffer( ch );
         if( IS_OBJ_STAT( obj, ITEM_PROTOTYPE ) )
         {
            if( can_omodify( ch, obj ) )
            {
               STRFREE( obj->pIndexData->lore );
               obj->pIndexData->lore = QUICKLINK( obj->lore );
            }
         }
         tmpobj = ( OBJ_DATA * ) ch->spare_ptr;
         stop_editing( ch );
   ...
   if( arg1[0] == '\0' || arg2[0] == '\0' || !str_cmp( arg1, "?" ) )
   {
      ...
      send_to_char( "  size\r\n", ch );
      send_to_char( "  affect rmaffect layers lore\r\n", ch );
      send_to_char( "For weapons:             For armor:\r\n", ch );
      send_to_char( "  weapontype condition     ac condition armortype\r\n", ch );
   ...
   if( !str_cmp( arg2, "lore" ) )
   {
      ...
      if( lockobj )
         ...
         ch->spare_ptr = NULL;
      ch->substate = SUB_OBJ_LORE;
      ch->dest_buf = obj;
      start_editing( ch, obj->lore );
      return;
   }
   ...
   if( !str_cmp( arg2, "armortype" ) )
   {
      ...
      {
         send_to_char( "Only usable on armor.\r\n", ch );
         return;
      }
      
      if( value < 0 || value > MAX_ARMOR_TYPE-1 )
      {
         ch_printf( ch, "Range is 0 to %d.\r\n", MAX_ARMOR_TYPE-1 );
         return;
      }
      
      obj->armor_type = value;
      if( IS_OBJ_STAT( obj, ITEM_PROTOTYPE ) )
         obj->pIndexData->armor_type = value;
      return;
   }
   ...
   if( !str_cmp( arg2, "size" ) )
   {
      ...
      if( value < 0 || value > 5 )
      {
         ch_printf( ch, "Range is 0 to 5.\r\n" );
         return;
      }
      
      obj->size = value;
      if( IS_OBJ_STAT( obj, ITEM_PROTOTYPE ) )
         obj->pIndexData->size = value;
      return;
   }
...
void do_redit( CHAR_DATA* ch, const char* argument)
{
   ...
   switch ( ch->substate )
   {
      ...
      case SUB_ROOM_PERDESC:
         location = ( ROOM_INDEX_DATA * ) ch->dest_buf;
         if( !location )
         {
            bug( "%s", "redit: sub_room_perdesc: NULL ch->dest_buf" );
            location = ch->in_room;
         }
         STRFREE( location->perdesc );
         location->perdesc = copy_buffer( ch );
         stop_editing( ch );
         ch->substate = ch->tempnum;
         return;
      
      case SUB_ROOM_NIGHTDESC:
         location = ( ROOM_INDEX_DATA * ) ch->dest_buf;
         if( !location )
         {
            bug( "%s", "redit: sub_room_nightdesc: NULL ch->dest_buf" );
            location = ch->in_room;
         }
         STRFREE( location->nightdesc );
         location->nightdesc = copy_buffer( ch );
         stop_editing( ch );
         ch->substate = ch->tempnum;
         return;
   ...
   if( arg[0] == '\0' || !str_cmp( arg, "?" ) )
   {
      ...
      send_to_char( " perdesc percheck nightdesc\r\n", ch );
      send_to_char( " excoord height", ch );
      return;
   }
   ...
   if( !str_cmp( arg, "perdesc" ) )
   {
      if( ch->substate == SUB_REPEATCMD )
         ch->tempnum = SUB_REPEATCMD;
      else
         ch->tempnum = SUB_NONE;
      ch->substate = SUB_ROOM_PERDESC;
      ch->dest_buf = location;
      start_editing( ch, location->perdesc );
      return;
   }
   
   if( !str_cmp( arg, "nightdesc" ) )
   {
      if( ch->substate == SUB_REPEATCMD )
         ch->tempnum = SUB_REPEATCMD;
      else
         ch->tempnum = SUB_NONE;
      ch->substate = SUB_ROOM_NIGHTDESC;
      ch->dest_buf = location;
      start_editing( ch, location->nightdesc );
      return;
   }
   
   if( !str_cmp( arg, "percheck" ) )
   {
      location->percheck = atoi( argument );
      return;
   }
   ...
   if( !str_cmp( arg, "sector" ) )
   {
      ...
      if( location->sector_type < 0 || location->sector_type >= SECT_MAX-1 )
      {
         location->sector_type = 1;
         send_to_char( "Out of range.\r\n", ch );
      }
      else
         ch_printf( ch, "Sector changed to %s.\r\n", sect_types[location->sector_type] );
      return;
   }
...
void edit_buffer( CHAR_DATA * ch, char *argument )
{
      ...
      if( !str_cmp( cmd + 1, "r" ) )
      {
         ...
         for( x = 0; x < edit->numlines; x++ )
         {
            ...
            while( ( wptr = strstr( lwptr, word1 ) ) != NULL )
            {
               ...
               if( lineln + wptr - edit->line[x] > 1024 )
                  buf[lineln] = '\0';
   ...
   {
      if( strlen( argument ) > 159 )
      {
         strncpy( buf, argument, 159 );
         buf[159] = '\0';
...
void fwrite_fuss_exit( FILE * fpout, EXIT_DATA * pexit )
{
   ...
   if( pexit->exit_info )
    ...
    if( pexit->x )
        fprintf( fpout, "MapX      %d\n", pexit->x );
    if( pexit->y )
        fprintf( fpout, "MapY      %d\n", pexit->y );
...
bool mprog_write_prog( FILE * fpout, MPROG_DATA * mprog )
{
   if( ( mprog->arglist && mprog->arglist[0] != '\0' ) )
   {
      ...
      if( mprog->arglist && mprog->arglist[0] != '\0' && !mprog->fileprog )
...
void fwrite_fuss_room( FILE * fpout, ROOM_INDEX_DATA * room, bool install )
{
   ...
   if( room->tele_delay > 0 || room->tele_vnum > 0 || room->tunnel > 0 || room->percheck > 0 )
      fprintf( fpout, "Stats    %d %d %d %d %d %d\n", room->tele_delay, room->tele_vnum, room->tunnel, room->max_weight, room->percheck, room->height );
   if( room->description && room->description[0] != '\0' )
      fprintf( fpout, "Desc     %s~\n", strip_cr( room->description ) );

   if( room->perdesc && room->perdesc[0] != '\0' )
      fprintf( fpout, "Perdesc  %s~\n", strip_cr( room->perdesc ) );
      
   if( room->nightdesc && room->nightdesc[0] != '\0' )
...
void fwrite_fuss_object( FILE * fpout, OBJ_INDEX_DATA * pObjIndex, bool install )
{
   ...
   if( pObjIndex->lore && pObjIndex->lore[0] != '\0' )
   ...
   fprintf( fpout, "Values2  %d %d\n", pObjIndex->armor_type, pObjIndex->size );
   fprintf( fpout, "Stats    %d %d %d %d %d %d %d\n", pObjIndex->weight,
            pObjIndex->gold_cost, pObjIndex->silver_cost, pObjIndex->copper_cost, pObjIndex->rent ? pObjIndex->rent : ( int )( pObjIndex->gold_cost / 10 ),
...
void fwrite_fuss_mobile( FILE * fpout, MOB_INDEX_DATA * pMobIndex, bool install )
{
   ...
   if( pMobIndex->lore && pMobIndex->lore[0] != '\0' )
      fprintf( fpout, "Lore       %s~\n", strip_cr( pMobIndex->lore ) );
   ...
   fprintf( fpout, "Stats1     %d %d %d %d %d %d %d %d %d %d\n", pMobIndex->alignment, pMobIndex->level, pMobIndex->challenge_rating, pMobIndex->mobthac0,
            pMobIndex->base_armor, pMobIndex->armor, pMobIndex->gold, pMobIndex->silver, pMobIndex->copper, pMobIndex->exp );
   ...
   fprintf( fpout, "Stats4     %d %d %d %d %d %d %d\n",
            pMobIndex->size, pMobIndex->type, pMobIndex->numattacks, pMobIndex->hitroll, pMobIndex->damroll, pMobIndex->z, pMobIndex->speechcolor );
   ...
   fprintf( fpout, "Saves      %d %d %d %d %d %d\n",
            pMobIndex->saving_str, pMobIndex->saving_dex, pMobIndex->saving_con,
            pMobIndex->saving_int, pMobIndex->saving_wis, pMobIndex->saving_cha );
   if( pMobIndex->speaks )
   ...
   if( !xIS_EMPTY( pMobIndex->defenses ) )
    ...
    if( !xIS_EMPTY( pMobIndex->subclasses ) )
        fprintf( fpout, "Subclasses   %s~\n", ext_flag_string( &pMobIndex->subclasses, subclass_flags ) );
    if( !xIS_EMPTY( pMobIndex->subrace ) )
        fprintf( fpout, "Subrace      %s~\n", ext_flag_string( &pMobIndex->subrace, subrace_flags ) );
...
void fwrite_area_header( FILE * fpout, AREA_DATA * tarea, bool install )
{
   ...
   if( tarea->lore && tarea->lore[0] != '\0' ) /* Seikyr */
      fprintf( fpout, "Lore         %s~\n", strip_cr( tarea->lore ) );
...
void old_fold_area( AREA_DATA * tarea, char *filename, bool install )
{
   ...
   for( vnum = tarea->low_m_vnum; vnum <= tarea->hi_m_vnum; vnum++ )
   {
      ...
      if( pMobIndex->perm_str != 13 || pMobIndex->perm_int != 13
          ...
          || !xIS_EMPTY( pMobIndex->subclasses )
          || !xIS_EMPTY( pMobIndex->subrace )
          || pMobIndex->size != 0 || pMobIndex->type != 0
      ...
      fprintf( fpout, "%d %d %d %d %d", pMobIndex->level, pMobIndex->challenge_rating, pMobIndex->mobthac0, pMobIndex->base_armor, pMobIndex->armor );
      ...
      if( complexmob )
      {
         ...
         fprintf( fpout, "%d %d %d %d %d %d\n",
                  pMobIndex->saving_str, pMobIndex->saving_dex,
                  pMobIndex->saving_con, pMobIndex->saving_int,
                  pMobIndex->saving_wis, pMobIndex->saving_cha );
         fprintf( fpout, "%d %d %d %d %d %d %d\n",
                  pMobIndex->race,
                  pMobIndex->Class,
                  pMobIndex->size, pMobIndex->type, pMobIndex->speaks, pMobIndex->speaking, pMobIndex->numattacks );
/*         fprintf( fpout, "%d %d %d %d %d %d %s ",
         ...
         fprintf( fpout, "%s\n", print_bitvector( &pMobIndex->subclasses ) );
         fprintf( fpout, "%s\n", print_bitvector( &pMobIndex->subrace ) );
      }
      if( pMobIndex->mudprogs )
      {
         int count = 0;
   ...
   for( vnum = tarea->low_r_vnum; vnum <= tarea->hi_r_vnum; vnum++ )
   {
      ...
      fprintf( fpout, "%s~\n", strip_cr( room->perdesc ) );
      fprintf( fpout, "%s~\n", strip_cr( room->nightdesc ) );
      if( ( room->tele_delay > 0 && room->tele_vnum > 0 ) || room->tunnel > 0 || room->max_weight > 0 || room->percheck > 0 || room->height > 0 )
         fprintf( fpout, "0 %s %d %d %d %d %d %d\n", print_bitvector( &room->room_flags ),
                  room->sector_type, room->tele_delay, room->tele_vnum, room->tunnel, room->max_weight, room->height );
      else
      ...
      for( xit = room->first_exit; xit; xit = xit->next )
      {
         ...
         if( xit->distance > 1 || xit->pull )
            ...
            fprintf( fpout, "%d %d %d %d %d\n", xit->exit_info & ~EX_BASHED, xit->key, xit->vnum, xit->x, xit->y );
      }
...
void do_astat( CHAR_DATA* ch, const char* argument)
{
   ...
   ch_printf_color( ch, "&wLore: &W%s\r\n", tarea->lore ? tarea->lore : "(default)" ); /* Seikyr */
}
...
void do_aset( CHAR_DATA* ch, const char* argument)
{
   ...
   switch ( ch->substate )
   {
      default:
         break;
      case SUB_AREA_LORE:
         if( ( tarea = ( AREA_DATA * ) ch->dest_buf ) == NULL )
         {
            bug( "%s", "aset: sub_area_lore: NULL ch->dest_buf" );
            stop_editing( ch );
            return;
         }
         STRFREE( tarea->lore );
         tarea->lore = copy_buffer( ch );
         stop_editing( ch );
         return;
   }
   ...
   if( arg1[0] == '\0' || arg2[0] == '\0' )
   {
      ...
      send_to_char( "  author credits resetmsg resetfreq flags lore\r\n", ch );
   ...
   if( !str_cmp( arg2, "lore" ) )
   {
      ...
      {
         STRFREE( tarea->lore );
         tarea->lore = STRALLOC( arg3 );
      }

      CHECK_SUBRESTRICTED( ch );
      ch->substate = SUB_AREA_LORE;
      ch->dest_buf = tarea;
      start_editing( ch, tarea->lore );
      return;
   }
