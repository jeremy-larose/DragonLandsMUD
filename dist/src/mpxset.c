...
void do_mpmset( CHAR_DATA* ch, const char* argument)
{
   ...
   if( !str_cmp( arg2, "savstr" ) )
   {
      ...
      {
         progbug( "MpMset: Invalid savstr", ch );
         return;
      }
   ...
   if( !str_cmp( arg2, "savdex" ) )
   {
      if( value < -30 || value > 30 )
      {
         progbug( "MpMset: Invalid savdex", ch );
         return;
      }
   ...
   if( !str_cmp( arg2, "savcon" ) )
   {
      if( value < -30 || value > 30 )
      {
         progbug( "MpMset: Invalid savcon", ch );
         return;
      }
   ...
   if( !str_cmp( arg2, "savint" ) )
   {
      if( value < -30 || value > 30 )
      {
         progbug( "MpMset: Invalid savint", ch );
         return;
      }
   ...
   if( !str_cmp( arg2, "savwis" ) )
   {
      if( value < -30 || value > 30 )
      {
         progbug( "MpMset: Invalid savwis", ch );
         return;
      }
   ...
   if( !str_cmp( arg2, "savcha" ) )
   {
      if( value < -30 || value > 30 )
      {
         progbug( "MpMset: Invalid savcha", ch );
         return;
      }
...
*/
   ...
   if( !str_cmp( arg2, "spec" ) )
   {
      ...
      if( ( victim->spec_fun = get_spec( arg3 ) ) == 0 )
      {
