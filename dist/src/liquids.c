...
void do_fill( CHAR_DATA* ch, const char* argument)
{
   ...
   if( dest_item == ITEM_CONTAINER )
   {
      ...
      {
         act( AT_PLAIN, "The $d is closed.", ch, NULL, obj->short_descr, TO_CHAR );
         return;
      }
   ...
   if( dest_item == ITEM_CONTAINER )
   {
      ...
      switch ( source->item_type )
      {
         ...
         case ITEM_CONTAINER:
            ...
            {
               act( AT_PLAIN, "The $d is closed.", ch, NULL, source->short_descr, TO_CHAR );
               return;
            }
   ...
   switch ( obj->item_type )
   {
      ...
      case ITEM_KEYRING:
         ...
         else
         {
            ...
            {
               act( AT_PLAIN, "The $d is closed.", ch, NULL, dest->short_descr, TO_CHAR );
               return;
            }
            separate_obj( dest );
